    ...
    <div class="cabecalho">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <h1 class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                ...
                <span class="fs-4">Lista de Usuários</span>
            </h1>
...
<button class="mb-2 btn btn-lg rounded-3 btn-primary" onclick="novoUsuario()" id="Novo">Novo</button>
            ...
            <div>
                ...
                <div class="modal-body p-5 pt-0">
                    <form class="" id="form">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" id="txtemail" name="txtemail" required class="form-control rounded-3">
                            <label for="floatingPassword">Email</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input input type="password" id="txtsenha" name="txtsenha" required class="form-control rounded-3">
